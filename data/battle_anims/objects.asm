...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_WISP
	; battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_0C, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_WISP
