...
CooltrainerMGroup:
	...
	; COOLTRAINERM (21)
	db "DEBUG@", TRAINERTYPE_ITEM_MOVES
	db 30, HOPPIP, FOCUS_SASH, SPLASH, SPLASH, SPLASH, SPLASH
	db 50, TYRANITAR, CHOICE_BAND, ROCK_SLIDE, ROCK_SLIDE, ROCK_SLIDE, ROCK_SLIDE
	db -1 ; end
