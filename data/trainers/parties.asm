...
LassGroup:
	...
	db 18, PSYDUCK,    DAZZLINGLEAM, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    DAZZLINGLEAM, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,    DAZZLINGLEAM, DISABLE, CONFUSION, SCREECH
	db 29, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    DAZZLINGLEAM, DISABLE, CONFUSION, SCREECH
...
CooltrainerMGroup:
	...
	db 50, DRAGONITE, DRAGON_CLAW, DRAGON_CLAW, DRAGON_CLAW, DRAGON_CLAW
	db -1 ; end
...
BeautyGroup:
	...
	db 16, MEOWTH,     DAZZLINGLEAM, GROWL, BITE, PAY_DAY
	db 16, MEOWTH,     DAZZLINGLEAM, GROWL, BITE, SLASH
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    DAZZLINGLEAM, TAIL_WHIP, DISABLE, CONFUSION
...
TwinsGroup:
	...
	db 16, JIGGLYPUFF, SING, DEFENSE_CURL, DRAGON_CLAW, DISABLE
	db -1 ; end
